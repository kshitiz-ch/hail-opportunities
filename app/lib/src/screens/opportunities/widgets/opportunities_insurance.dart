      ...
      child: Column(
        ...
        children: [
          ...
          _buildInsuranceLeadItem(
            ...
            badgeTextColor: const Color(0xFF6725F4),
          ),
          ...
          _buildInsuranceLeadItem(
            ...
            score: 88,
            gap: '₹50,000',
            badgeText: 'High Net Worth',
            badgeColor: const Color(0xFFF8EEE2),
            badgeTextColor: const Color(0xFFF98814),
          ),
        ],
      ),
    );
