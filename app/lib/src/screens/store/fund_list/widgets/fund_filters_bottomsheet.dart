...
import 'package:app/src/screens/store/fund_list/widgets/fund_filter_options.dart';
import 'package:app/src/screens/store/fund_list/widgets/fund_sorting_options.dart';
      ...
      initState: (_) {
        WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
          if (Get.isRegistered<FundsController>()) {
            Get.find<FundsController>().changeFilterMode(filterMode);
          }
        });
      },
      builder: (controller) {
