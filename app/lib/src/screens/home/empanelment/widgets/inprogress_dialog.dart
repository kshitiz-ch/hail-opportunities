...
class InProgressDialog extends StatelessWidget {
  const InProgressDialog({Key? key, required this.controller})
      : super(key: key);
                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 32),
                        Text(
                          'Your Empanelment Journey is in Progress!',
                        ...
                        SizedBox(height: 16),
                        Text(
                          'Your Empanelment Journey Started, but dropped off in the middle Proceed to finish.',
                          textAlign: TextAlign.center,
                          style: Theme.of(context)
                              .primaryTextTheme
                              .headlineSmall!
